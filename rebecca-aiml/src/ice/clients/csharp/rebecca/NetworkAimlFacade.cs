...
namespace rebecca
{
    ...
    public class NetworkAimlFacade
    {
         ...
         */
        public NetworkAimlFacade(string[] args) 
        {
            graphBuilder = new rebecca.impl.NetworkGraphBuilderAIML(args);
        }
         ...
         */
        private rebecca.impl.NetworkGraphBuilderAIML graphBuilder;
    }
