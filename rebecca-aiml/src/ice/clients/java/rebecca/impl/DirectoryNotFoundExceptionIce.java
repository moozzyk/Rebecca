...
public class DirectoryNotFoundExceptionIce extends ExceptionIce
{
    ...
    public DirectoryNotFoundExceptionIce(String what)
    {
        super(what);
    }
    ...
    {
        __os.writeString("::rebecca::impl::DirectoryNotFoundExceptionIce");
