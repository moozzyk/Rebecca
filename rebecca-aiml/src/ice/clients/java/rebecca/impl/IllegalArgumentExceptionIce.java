...
public class IllegalArgumentExceptionIce extends ExceptionIce
{
    ...
    public IllegalArgumentExceptionIce(String what)
    {
        super(what);
    }
    ...
    {
        __os.writeString("::rebecca::impl::IllegalArgumentExceptionIce");
