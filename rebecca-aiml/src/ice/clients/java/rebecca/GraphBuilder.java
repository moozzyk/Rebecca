...
public interface GraphBuilder {
	 ...
	 * Examples that work under both Unix and Windows:
	 * <pre>
	   builder.removeDirectoryWithFilesEndingInRegularExpression("/someDir/someFile.aiml", ".*\\.aiml");
	   builder.removeDirectoryWithFilesEndingInRegularExpression("../../someDir/someFile.aiml", ".*\\.aiml");
	   </pre>
     *
	 * Some examples that <b>only</b> work under Windows.
	 * <pre>
	   builder.removeDirectoryWithFilesEndingInRegularExpression("C:\\someDir\\someFile.aiml", ".*\\.aiml");
	   builder.removeDirectoryWithFilesEndingInRegularExpression("C:/someDir/someFile.aiml", ".*\\.aiml");
	   builder.removeDirectoryWithFilesEndingInRegularExpression("..\\..\\someDir\\someFile.aiml", ".*\\.aiml");
	   </pre>
	 * 
	 ...
	 * exception, it will be wrapped and thrown as a Exception.
	 */
    public void removeDirectoryWithFilesEndingInRegularExpression(String directory, String regularExpression)
		throws IllegalArgumentException, DirectoryNotFoundException, Exception;
	 ...
	 * Examples that work under both Unix and Windows:
	 * <pre>
	   builder.removeDirectoryWithFilesEndingInRegularExpression("/someDir/someFile.aiml", ".*\\.aiml", "myUser", "myBot", "myEndUser");
	   builder.removeDirectoryWithFilesEndingInRegularExpression("../../someDir/someFile.aiml", ".*\\.aiml", "myUser", "myBot", "myEndUser");
	   </pre>
     *
	 * Some examples that <b>only</b> work under Windows.
	 * <pre>
	   builder.removeDirectoryWithFilesEndingInRegularExpression("C:\\someDir\\someFile.aiml", ".*\\.aiml", "myUser", "myBot", "myEndUser");
	   builder.removeDirectoryWithFilesEndingInRegularExpression("C:/someDir/someFile.aiml", ".*\\.aiml", "myUser", "myBot", "myEndUser");
	   builder.removeDirectoryWithFilesEndingInRegularExpression("..\\..\\someDir\\someFile.aiml", ".*\\.aiml", "myUser", "myBot", "myEndUser");
	   </pre>
	 * 
	 ...
	 * be wrapped and thrown as an Exception.
	 */
    public boolean predicateMatch(String predicateName, String aimlPattern)
        throws Exception;
