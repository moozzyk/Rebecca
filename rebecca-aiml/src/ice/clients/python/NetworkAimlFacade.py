...
from NetworkGraphBuilderAIML import *
...
class NetworkAimlFacade:
    ...
    # private variables
    __networkGraphBuilder = NetworkGraphBuilder
    """
    ...
    def __init__(self, args):
        ...
        """
        self.__networkGraphBuilder = NetworkGraphBuilderAIML(args)
    ...
    def destroy(self):
        ...
        """
        self.__networkGraphBuilder.destroy()

    def getNetworkGraphBuilder(self):
        """
        ...
        """
        return self.__networkGraphBuilder
